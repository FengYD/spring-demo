 ...
 * @Description 在坐标系添加网格线
 */
@Slf4j
public class C02E02_GridLines {

    public static final String DEST = "spring-demo-itext7/results/chapter02/2.grid_lines.pdf";

    public static void main(String[] args) throws IOException {
        File file = new File(DEST);
        file.getParentFile().mkdirs();
        new C02E02_GridLines().createPdf(DEST);
        log.info("success generate pdf 2.grid_lines.pdf");
    }
