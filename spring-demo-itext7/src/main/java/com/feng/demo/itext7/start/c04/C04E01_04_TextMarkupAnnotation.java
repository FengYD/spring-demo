...
public class C04E01_04_TextMarkupAnnotation {
    ...
    public static final String DEST = "spring-demo-itext7/results/chapter04/4.textmarkup_annotation.pdf";

    public static void main(String[] args) throws IOException {
        File file = new File(DEST);
        file.getParentFile().mkdirs();
        new C04E01_04_TextMarkupAnnotation().createPdf(DEST);
        log.info("success generate pdf 4.textmarkup_annotation.pdf");
    }
